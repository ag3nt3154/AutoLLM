expert_template = """Instruction:
Examine and reference the following examples to write a high-quality description about the most capable and suitable agent to execute the instruction in second person perspective.
...
- thinking: (str) Return your thinking process to arrive at the agent and his or her description.
- agent_description: (str) Return a description of the most capable and suitable agent to execute the instruction.

--------------------------------------
Input:
You should write a description about the most capable and suitable agent to execute the following instruction below.
